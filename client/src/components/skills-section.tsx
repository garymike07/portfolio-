    ...
    <section id="skills" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          {/* Web Technologies */}
          <div className="neuro-box hover-lift p-6 sm:p-8">
            <h3 className="text-xl sm:text-2xl font-semibold mb-6 sm:mb-8 text-purple-400" data-testid="web-technologies-title">
        ...
        <div className="mt-12 sm:mt-16">
          <h3 className="text-2xl sm:text-3xl font-semibold text-center mb-8 sm:mb-12 gradient-text" data-testid="personal-skills-title">
            Personal Skills
          </h3>
